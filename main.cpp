...
void driverMenu(UberSystem &sys)
{
    while (true)
    {
        ...
        case 3:
            ...
            break;
        case 4:
            sys.toggleDriverAvailability();
            break;
        case 5:
            sys.updateDriverLocation();
            break;
        case 0:
            return;
        }
...
void algorithmMenu(UberSystem &sys)
{
    while (true)
    {
        ...
        cout << "\n  " << UI::BOLD << "Graph Algorithms:\n"
             << UI::RESET;
        UI::menuItem(1, "Dijkstra       — Shortest path between locations");
        UI::menuItem(2, "Bellman-Ford   — Traffic-aware shortest route");
        UI::menuItem(3, "Prim's MST     — Minimum road network (Prim's)");
        UI::menuItem(4, "Kruskal's MST  — Minimum road network (Kruskal's)");
        UI::menuItem(5, "Compare MSTs   — Prim's vs Kruskal's side by side");
...
void mapMenu(UberSystem &sys)
{
    ...
    {
        UI::header("CITY MAP");
        UI::menuItem(1, "View All Locations");
        UI::menuItem(2, "Add New Road");
        UI::menuItem(0, "Back");
...
int main()
{
    ...
    while (true)
    {
        UI::banner();
        cout << "\n";
        UI::menuItem(1, "Book a Ride          (Dijkstra — nearest driver)");
        ...
        int ch = UI::getInt("Choose an option", 0, 7);
        UI::clearScreen();
        ...
        case 0:
            UI::header("GOODBYE");
            cout << "\n  " << UI::CYAN << "  Thank you for using Uber DSA System!\n\n"
                 << UI::RESET;
            return 0;
        }
    }
